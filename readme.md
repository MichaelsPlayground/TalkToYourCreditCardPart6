# Talk to your Credit Card part 6
...
The description can be found in an article series on medium.com: https://medium.com/@androidcrypto/talk-to-your-credit-card-part-6-read-all-files-given-in-the-afl-list-17e2e5d71c6e
...
This is the app for the sixth step 6: **read all files given in the AFL list** in **TalkToYourCreditCardPart6**.
...
![step 2: after reading a Credit Card](docs/app06a.png?raw=true) ![step 2: after reading a Credit Card](docs/app06b.png?raw=true)
